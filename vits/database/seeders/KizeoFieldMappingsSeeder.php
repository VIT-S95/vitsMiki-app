...
class KizeoFieldMappingsSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('kizeo_field_mappings')->insertOrIgnore([
            ...
            // Nouveau formulaire — ID à remplacer par le vrai ID Kizeo du nouveau formulaire
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => '_id', 'app_field' => 'numero_bon_kizeo', 'transform' => null, 'notes' => ''],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'date', 'app_field' => 'date_intervention', 'transform' => null, 'notes' => ''],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => '_answer_time', 'app_field' => 'heure_intervention', 'transform' => 'substr_11_5', 'notes' => ''],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => '_last_name', 'app_field' => 'technicien', 'transform' => 'concat_prenom_nom', 'notes' => ''],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => '_first_name', 'app_field' => 'technicien', 'transform' => 'concat_prenom_nom', 'notes' => ''],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'societe', 'app_field' => 'client_nom', 'transform' => null, 'notes' => 'Liste déroulante alimentée par app'],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'autre_societe', 'app_field' => 'pending_client', 'transform' => 'file_attente', 'notes' => 'Client inconnu → file attente admin'],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'inter_cloture', 'app_field' => 'statut', 'transform' => 'cloture_nouveau', 'notes' => '1 → traitee'],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'type_intervention', 'app_field' => 'type', 'transform' => 'type_nouveau', 'notes' => 'Sur site, A distance, Atelier'],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'flash', 'app_field' => 'type', 'transform' => 'logique_flash', 'notes' => ''],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'duree_inter_site_1', 'app_field' => 'duree_minutes', 'transform' => 'heures_fois_60', 'notes' => 'Si type = Sur site'],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'duree_inter_distant_1', 'app_field' => 'duree_minutes', 'transform' => 'parse_duree_20', 'notes' => 'Si type = A distance, sauf autre'],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'duree_inter_distant_2', 'app_field' => 'duree_minutes', 'transform' => 'parse_duree_20', 'notes' => 'Si duree_inter_distant_1 = autre'],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'temps_complementaire', 'app_field' => 'duree_devis_minutes', 'transform' => 'heures_fois_60', 'notes' => ''],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'contrat', 'app_field' => 'deductible', 'transform' => 'logique_deductible', 'notes' => ''],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'forfait_devis', 'app_field' => 'deductible', 'transform' => 'logique_deductible', 'notes' => 'Remplace forfait'],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'commentaires', 'app_field' => 'commentaires', 'transform' => null, 'notes' => ''],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'hors_heure_ouvree', 'app_field' => 'hors_heure_ouvree', 'transform' => 'bool_oui_non', 'notes' => ''],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'donneur_ordre', 'app_field' => 'donneur_ordre', 'transform' => null, 'notes' => ''],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'n_ticket', 'app_field' => 'n_ticket', 'transform' => null, 'notes' => ''],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'n_devis', 'app_field' => 'n_devis', 'transform' => null, 'notes' => ''],
            ['form_id' => 'NOUVEAU_FORM_ID', 'kizeo_field' => 'ce_client_n_a_pas_de_contrat', 'app_field' => null, 'transform' => 'raw_data', 'notes' => 'Info terrain uniquement'],
        ]);
    }
}
